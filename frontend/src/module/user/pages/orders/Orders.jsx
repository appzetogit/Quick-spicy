    ...
    const fetchOrders = async () => {
      try {
        ...
        if (ordersData.length > 0) {
          ...
          debugLog('⚠️ No orders data in response')
          setOrders([])
        }
      } catch (error) {
...
Order again from this restaurant in the ${companyName} app.`
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-10 font-sans transition-colors">
      {/* Header */}
      <div className="bg-white dark:bg-[#111111] p-4 flex items-center shadow-sm sticky top-0 z-10 border-b border-transparent dark:border-gray-800">
        <Link to="/user">
          <ArrowLeft className="w-6 h-6 text-gray-700 dark:text-gray-200 cursor-pointer" />
      ...
      <div className="p-4 bg-white dark:bg-[#111111] mt-1">
        <div className="flex items-center bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg px-3 py-2 shadow-sm">
      ...
      <div className="px-4 py-2 space-y-4">
        {filteredOrders.length === 0 ? (
          <div className="bg-white dark:bg-[#141414] rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-8 text-center">
          ...
          filteredOrders.map((order) => {
            ...
            return (
              <div key={order.id} className="relative bg-white dark:bg-[#141414] rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                ...
                {/* Order Summary */}
                <div className="px-4 py-3 bg-gray-50 dark:bg-[#101010] rounded-lg mx-4 mb-2">
      ...
      {ratingModal.open && ratingModal.order && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 animate-in fade-in duration-200">
          <div className="w-full max-w-md rounded-3xl bg-white dark:bg-[#141414] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-transparent dark:border-gray-800">
            ...
            <div className="px-6 py-6">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-[#101010] px-4 py-3 text-sm text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#EB590E] focus:border-[#EB590E] resize-none transition-all"
