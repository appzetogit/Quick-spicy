...
export default function SendFeedback() {
  ...
  return (
    <AnimatedPage className="min-h-screen bg-[#f5f5f5] dark:bg-[#0a0a0a]">
      <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8 py-4 md:py-6 lg:py-8 pb-24 md:pb-8">
        {/* Header */}
            ...
            <Card className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-sm border-0 dark:border-gray-800 mb-4 md:mb-5 lg:mb-6">
              <CardContent className="p-4 md:p-5 lg:p-6">
                ...
                <Textarea
                  ...
                  className="min-h-[250px] md:min-h-[350px] lg:min-h-[400px] w-full resize-y px-3 py-3 md:px-4 md:py-4 text-sm md:text-base leading-relaxed"
                  dir="ltr"
                  style={{
                    direction: 'ltr',
                    textAlign: 'left',
