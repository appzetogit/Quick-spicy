...
export const authenticate = async (req, res, next) => {
  try {
    ...
    // tokenVersion on every routine rotation, and any other request already in flight - the
    // WebView app polling for orders, another device - is still holding the access token
    ...
    if (
      ...
      decideRotation(restaurant, decoded.tokenVersion) === ROTATION_DECISION.REVOKE
    ) {
