...
export const logout = asyncHandler(async (req, res) => {
  ...
  if (req.restaurant) {
    req.restaurant.tokenVersion = Number(req.restaurant.tokenVersion || 0) + 1;
    req.restaurant.previousTokenVersion = null;
    req.restaurant.tokenVersionRotatedAt = new Date();
